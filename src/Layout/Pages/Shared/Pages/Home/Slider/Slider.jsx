...
const Slider = () => {
  ...
  return (
    ...
    <motion.div
      ...
      className={`my-0 py-0 pb-24 relative  ${
        darkModeState
          ? "lg:bg-gradient-to-b from-green-200 to-transparent"
          : "lg:bg-gradient-to-b from-slate-900 to-slate-800"
      }`}
    >
      <div
        ref={sliderRef}
      ...
      >
        <div className="keen-slider__slide number-slide1 relative">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center z-10">
            <div
              className={`w-1/2 lg:w-1/3 text-center p-2 lg:p-6 rounded-full  rounded-ss-none shadow-lg ${
                darkModeState
            ...
            <Link to="#footer">
              <button
                className={`btn btn-xs lg:btn-lg mt-4  hover:bg-slate-900 text-white border-none tracking-widest ${
                  darkModeState
