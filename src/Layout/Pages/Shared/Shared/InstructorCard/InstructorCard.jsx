...
const InstructorCard = ({userSolo}) => {
    const {name,email,image,no_of_classes, total_students} = userSolo;
  ...
  return (
    <div className="card card-side bg-base-100 hover:bg-base-200 transition-all duration-200 ease-in shadow-xl cursor-default">
      ...
      <div className="card-body ml-8 px-1 py-6">
        ...
        <div className='flex flex-col w-max items-center'><SiGoogleclassroom className='mt-2 text-2xl text-slate-600'/><span className='text-2xl font-bold text-green-600'>{no_of_classes}</span></div>
